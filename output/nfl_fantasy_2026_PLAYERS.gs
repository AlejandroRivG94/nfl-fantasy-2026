...
function updatePlayersDB_2026_VERIFIED() {
  ...
  var data = [
    ...
    ['Saquon Barkley',        'RB','PHI','1', 14.7, 15.0, 'OL élite PHI. 290 carries + 1400 yds + 14 TDs. Tank Bigsby backup (ADP 180). Must-start toda la temporada.','No','','','Easy','Élite'],
    ...
    ['Josh Allen',            'QB','BUF','1', 20.7, 21.0, 'Elite dual-threat QB. 130 carries + 12 TDs terrestres. Custom format lo eleva. DJ Moore WR1. ADP bajo = gran valor.','No','','','Easy','Muy buena'],
    ...
    ['Malik Nabers',          'WR','NYG','1', 25.7, 26.0, 'WR élite NYG. Año 3 (clase 2024). Jaxson Dart QB nuevo. Cam Skattebo RB. OL pobre NYG pero Nabers genera YAC.','No','','','Neutral','Promedio'],
    ...
    ['Colston Loveland',      'TE','CHI','2', 36.0, 36.3, 'Año 2 (clase 2025). TE CHI. Caleb Williams QB Año 3. Odunze + Burden WRs. Breakout TE potencial. Waldron OC.','No','','','Easy','Pobre'],
    ...
    ['Zay Flowers',           'WR','BAL','2', 41.7, 42.0, 'WR1 BAL. Lamar Jackson QB. 85 rec + 1050 yds + 8 TDs. Red zone creciente. Año 4.','No','','','Neutral','Muy buena'],
    ['Cam Skattebo',          'RB','NYG','2', 42.0, 42.3, 'Año 2 (clase 2025). RB NYG. Jaxson Dart QB nuevo. Nabers WR1. OL pobre NYG. Workhorse por default.','No','','','Neutral','Promedio'],
    ['Lamar Jackson',         'QB','BAL','2', 43.0, 43.4, 'MVP x2. Mejor QB Custom format .2PPC. 140 carries + 950 yds. 36 passTDs. BAL OL muy sólida. ADP bajo = gran valor.','No','','','Neutral','Muy buena'],
    ...
    ['TreVeyon Henderson',    'RB', 'NE','2', 52.3, 52.6, 'Año 2 (clase 2025). RB NE. Drake Maye QB Año 3. Van Pelt OC. 180 carries + 55 rec proyectados. Upside alto.','Yes','','','Neutral','Pobre'],
    ...
    ['Drake Maye',            'QB', 'NE','2', 57.0, 57.3, 'Año 3 (clase 2024). Dual-threat QB. Van Pelt OC. Henderson RB. 3800 yds + 30 TDs + 550 rushYds. Upside enorme.','Yes','','','Neutral','Pobre'],
    ['Jayden Daniels',        'QB','WAS','2', 57.3, 57.6, 'Año 3 (clase 2024). Kingsbury OC Año 2 = más pase. McLaurin WR1. 3900 yds + 28 TDs + 700 rushYds. Custom format sólido.','No','','','Hard','Buena'],
    ...
    ['Caleb Williams',        'QB','CHI','2', 66.7, 67.0, 'Año 3 (clase 2024). Waldron OC Año 2. Swift RB. Burden + Odunze WRs. Ceiling élite dual-threat. OL aún pobre.','No','','','Easy','Pobre'],
    ...
    ['Carnell Tate',          'WR','TEN','2', 72.7, 73.0, 'Año 2 (clase 2025). WR TEN. Cam Ward QB Año 2. Holz OC Año 2. Pollard RB. Breakout candidato WR Year 2.','No','','','Neutral','Promedio'],
    ...
    ['Jaxson Dart',           'QB','NYG','3', 84.7, 85.0, 'Año 2 (clase 2025). QB NYG. Nabers WR1. Skattebo RB. Likely TE. OL pobre NYG. Upside joven QB si OL mejora.','No','','','Neutral','Promedio'],
    ...
    ['Tony Pollard',          'RB','TEN','3', 86.0, 86.3, 'RB TEN. Cam Ward QB Año 2. Holz OC Año 2. Carnell Tate WR. 200 carries + 55 rec. Schedule neutral.','No','','','Neutral','Promedio'],
    ...
    ['Patrick Mahomes',       'QB', 'KC','3', 88.7, 89.0, 'KC dynasty. Rice WR1. Worthy WR2. Walker RB. 4500 yds + 38 TDs. ADP 89 = valor como QB2 en superflex.','No','','','Hard','Élite'],
    ...
    ['Cam Ward',              'QB','TEN','4',141.0,141.3, 'Año 2 (clase 2025). QB TEN. Holz OC Año 2. Pollard RB. Tate + Robinson WRs. Dual-threat. 3500 yds + 25 TDs + 600 rushYds.','No','','','Neutral','Promedio'],
